...
class ContractListSerializer(serializers.ModelSerializer):
    ...
    #
    #     if obj.type == BaseContract.Type.CUSTOMER:
    #         if obj.custom_contract_type == CustomerTemplateAgreement.Type.INTERNATIONAL:
    #             return BaseContract.Type.INTERNATIONAL
    #         return obj.custom_contract_type
    #
    #     return obj.type
...
class OneTimeUpdateSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        if executor_data:
            ...
            Person.objects.update_or_create(id=instance.executor.id, defaults=executor_data)
            instance.executor.refresh_from_db()
            if executor_contact_data:
                Contact.objects.update_or_create(person=instance.executor, defaults=executor_contact_data)
