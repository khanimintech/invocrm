...
from api.main_models.contract import BaseContract, TradeAgreement, AgreementEntity, Bank, BankAccount
...
class TestContractListAPIView:
    ...
    def test_contract_list_ok(self, apiclient, admin_user, sales_manager):
        ...
        response = apiclient.get(reverse('api:v1:contracts'))

        assert response.status_code == 200


class TestTradeAgreementCreateAPIView:
    ...
    def test_trade_create(self, apiclient, admin_user, sales_manager):
        ...
        admin_user.save()
        apiclient.force_login(admin_user)
        response = apiclient.post(reverse('api:v1:trade-create'),
                                  data={
                                      'contract_no': 123,
        ...
        assert entity.type == AgreementEntity.MMC
