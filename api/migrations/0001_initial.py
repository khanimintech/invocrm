...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='AgreementEntity',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.SmallIntegerField(choices=[(1, 'MMC'), (2, 'ASC'), (3, 'QSC'), (4, 'Individual')])),
                ('name', models.CharField(max_length=256, verbose_name='Company/Invidiualname')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[(1, 'Trade'), (2, 'Service'), (3, 'Distribution'), (4, 'Agent'), (5, 'Rent'), (6, 'One-time'), (7, 'Purchase order'), (8, 'International')], max_length=40)),
                ('created', models.DateTimeField(default=django.utils.timezone.now)),
                ('due_date', models.DateTimeField()),
                ('status', models.CharField(choices=[(0, 'In process'), (1, 'Approved'), (2, 'Expired')], default=0, max_length=40)),
                ('entity', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.agreemententity')),
            ],
        ),
        migrations.CreateModel(
            name='Contact',
        ...
        migrations.AddField(
            ...
            name='executive',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='my_contracts', to='api.person'),
        ),
        migrations.AddField(
            model_name='basecontract',
            name='sales_manager',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.agreemententity')),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('basecontract_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='api.basecontract')),
                ('responsible_person', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='trade_agreements', to='api.person')),
            ],
            bases=('api.basecontract',),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('basecontract_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='api.basecontract')),
                ('responsible_person', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='service_agreements', to='api.person')),
            ],
            bases=('api.basecontract',),
        ),
        migrations.CreateModel(
