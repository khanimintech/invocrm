    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('annex', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='api.baseannex')),
        ...
        migrations.AddField(
            model_name='basecontract',
            name='executor',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='contract', to='api.person'),
        ),
        migrations.AddField(
            model_name='basecontract',
            name='responsible_person',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='agreement', to='api.person'),
        ),
        migrations.AddField(
            model_name='basecontract',
            name='sales_manager',
        ...
        migrations.AddField(
            ...
            name='contract',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='annex_list', to='api.basecontract'),
        ),
        migrations.AddField(
            model_name='baseannex',
            name='sales_manager',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sales_manager_annex_list', to='api.person'),
        ),
        migrations.AddField(
            model_name='baseannex',
            name='seller',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='seller_annex_list', to='api.person'),
        ),
        migrations.CreateModel(
            name='BankAccount',
            fields=[
                ...
                ('company_owner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.company')),
                ('personal_owner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.person')),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
